...
func (app *Config) PostLoginPage(w http.ResponseWriter, r *http.Request) {
	...
	// get email and password ferom post
...
func (app *Config) SubscribeToPlan(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		app.Session.Put(r.Context(), "error", "Error getting user from database to plan!")
		http.Redirect(w, r, "/members/plan", http.StatusSeeOther)
		return
	}
...
func (app *Config) ChooseSubscription(w http.ResponseWriter, r *http.Request) {
	if !app.Session.Exists(r.Context(), "userID") {
		app.Session.Put(r.Context(), "warning", "You must log in to ses this page")
